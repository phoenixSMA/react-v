...
export enum Actions {
    ...
    SET_TRADER_STATUS = 'SET_TRADER_STATUS',
...
export interface SetTraderStatus {
    type: typeof Actions.SET_TRADER_STATUS;
    payload: TraderStatus;
}

export interface ChangeTraderStatus {
    type: typeof Actions.CHANGE_TRADER_STATUS,
}
